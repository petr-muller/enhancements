---
title: upgrade-health-api-and-presentation
authors:
  - "@petr-muller"
reviewers:
  - "@wking"
...
tracking-link:
  - https://issues.redhat.com/browse/OTA-1114
see-also:
  - https://github.com/jupierce/oc-update-design-ideas/blob/main/status.md
replaces: []
superseded-by: []
---

# Upgrade Health API and Presentation

## Summary

This document proposes a new API and user-oriented CLI presentation layer of this
API, to provide a users a clear view of the health of OpenShift upgrade process.
